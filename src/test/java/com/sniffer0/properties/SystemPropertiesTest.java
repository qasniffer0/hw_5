package com.sniffer0.properties;
...
public class SystemPropertiesTest {
    ...
    void simpleProperty4Test() {
        ...
        // gradle clean one_property_test запуск из терминала
        // gradle clean one_property_test -Dbrowser=safari запуск из терминала с параметрами
    }
